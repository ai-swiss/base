...
| **Propositions commerciales** | Rédige des propositions détaillées, adaptées au client et au contexte |
| **Suivi client** | Gère les relances, suit la satisfaction, identifie les opportunités |

> *Exemple disponible: [assistant-devis](../../exemples/assistant-devis/), prêt à utiliser*
...
> *Exemple disponible: [assistant-communication](../../exemples/assistant-communication/), prêt à utiliser*
...
| **Gestion des absences** | Suit les congés, prépare les certificats, gère les remplacements |
| **Formation** | Identifie les besoins, conçoit les programmes, évalue les résultats |

> *Exemple disponible: [assistant-rh](../../exemples/assistant-rh/), prêt à utiliser*
...
| **Emails professionnels** | Rédige des réponses claires, adaptées au contexte et au destinataire |
| **Comptabilité** | Prépare les factures, suit les paiements, catégorise les dépenses à vérifier |

> *Exemples disponibles, prêts à utiliser: [assistant-projet](../../exemples/assistant-projet/) (gestion de projets), [assistant-reunion](../../exemples/assistant-reunion/) (procès-verbaux et suivi) et [assistant-courrier](../../exemples/assistant-courrier/) (courriers et emails)*
...
| **Cabinet médical** | Préparation de notes et courriers non diagnostiques, selon vos règles de confidentialité |
| **Cabinet vétérinaire** | Fiches animaux, suivi traitements, rappels vaccins |
| **Cabinet juridique** | Brouillons de contrats types, checklists, réponses structurées à relire par un juriste habilité |
...
| **Association** | Gestion membres, préparation AG, suivi dons, rapport annuel |
| **Fondation** | Appels à projets, suivi subventions, rapports d'impact |

> *Exemple disponible: [assistant-enseignant](../../exemples/assistant-enseignant/), prêt à utiliser*
...
| **Viticulteur** | Suivi vignoble, gestion cave, commercialisation, étiquetage |
...
1. **Quelle tâche me prend le plus de temps chaque semaine?**
