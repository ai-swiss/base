...
This license is made to spread a method: you can copy, adapt, and redistribute, including for commercial use, provided you attribute the source.

Recommended attribution:

> BASE, Build Assistants with a Structure of Expertise, by AI Swiss, https://a-i.swiss

## Legal source

The `LICENSE` file at the root remains the repository's legal reference.
