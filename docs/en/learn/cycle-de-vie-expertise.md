<!-- fr-synced: 43030d64ab5fc1919ae4dfa3856c0b419a129d1b -->
# Keeping an expertise alive after deployment

"And after deployment?" That is the question decision-makers ask, and it is the right one. This page is for the leaders who deploy an assistant and want to know how it holds up over time. An assistant is not a project that ends: it is an expertise that lives. BASE supports every stage of that life, from the first document imported to aging under watch. Here is the full loop.
...
into its own at scale: all of BASE rests on a foundation of processes written and maintained by
people, but a few are **promoted and institutionalized**, and those are the ones to
keep under evaluation.

## 4. Run, at the host

The assistant runs in an AI tool able to read your files (for example GitHub Copilot, Antigravity, Claude Code, Cowork, OpenCode, or Kilo Code), or any MCP host, with the BASE broker
...
The know-how there stays independent of the model that runs it: tools come and go, context stays,
and changing models does not rewrite the expertise.
