...
→ **Et maintenant**: vous avez achevé le parcours Praticien: VOTRE assistant répond sur VOTRE contenu. Pour plusieurs personnes, voir le [parcours Equipe](equipe-1-workspace.md). Pour ancrer la méthode au quotidien: [La co-pensée en pratique, 16 principes](../learn/pratiques-co-pensee.md).
