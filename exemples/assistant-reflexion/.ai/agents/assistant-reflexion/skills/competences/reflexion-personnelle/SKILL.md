...
id: reflexion-personnelle
type: competence
title: Réflexion personnelle
description: "Méthode pour bien penser avec une IA quand le public est une seule personne: honnêteté, registres séparés, pensée qui se construit dans le temps. À consulter dans les process d'exploration et de décision."
scope: personal
status: active
