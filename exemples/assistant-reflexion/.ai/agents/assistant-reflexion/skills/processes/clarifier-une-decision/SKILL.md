...
keywords: [decision, choix, hesiter, trancher, dilemme, options, criteres, pour et contre, je ne sais pas si]
...
C'est l'étape qui protège la décision. Pour chaque option, mets en lumière ce sur quoi le raisonnement s'appuie sans en être certain:
...
C'est la personne qui décide ce qu'elle vérifie et ce qu'elle assume. Tu ne tranches pas à sa place ce qui mérite d'être vérifié.
...
Si une option l'emporte nettement sur les critères que la personne a jugés prioritaires, tu peux le **constater** («sur vos deux critères prioritaires, B ressort»), sans transformer ce constat en conseil.
...
Enregistre dans `reflexions/YYYY-MM-DD_sujet.md`, en conservant les marqueurs `[HYPOTHESE]`, `[INCERTITUDE]`, `[A VALIDER]` non résolus, afin que l'état du raisonnement reste visible.
...
- **Cacher une supposition**: ce qui n'est pas certain devient `[HYPOTHESE]` ou `[INCERTITUDE]`, au grand jour
