---
name: metier-reunion
description: "Anatomie d'un bon compte-rendu, distinction décision / action / information, attribution et datation des actions, discipline de neutralité et de factualité. À consulter lors de la rédaction d'un compte-rendu ou du suivi des actions."
...
Un compte-rendu utile contient, dans l'ordre:

1. **En-tête**: titre ou type de réunion, date, heure, lieu (ou «à distance»)
2. **Participants**: présents, excusés, et qui a rédigé le compte-rendu
3. **Ordre du jour**: la liste des sujets abordés
4. **Pour chaque sujet**:
   - un bref rappel du point discuté (factuel, neutre)
   - les **décisions** prises
   - les **actions** décidées (avec responsable et échéance)
   - les **informations** partagées
5. **Tableau récapitulatif des actions**: action, responsable, échéance, statut
6. **Prochaine réunion**: date et sujets pressentis, si connus

### Qualités d'un bon compte-rendu
...
|-----------|------------|------------------|
| **Décision** | Un choix arrêté collectivement | «Il est décidé que...», «Nous retenons l'option B», un vote, un accord explicite |
| **Action** | Une tâche concrète à réaliser | Un verbe d'action, un responsable, une échéance: «Marie envoie le devis avant vendredi» |
| **Information** | Un élément partagé, sans choix ni tâche | «Le chiffre d'affaires a progressé de 4%», un point de situation, une annonce |
...
- **Statut**: à faire / en cours / fait. Au moment du compte-rendu, en général «à faire».

Format recommandé pour le tableau des actions:

| Action | Responsable | Échéance | Statut |
|--------|-------------|----------|--------|
| Préparer le planning | Paul | 15 juin | À faire |
| Relancer le fournisseur | [A COMPLETER: responsable] | [A COMPLETER: échéance] | À faire |
...
## Types de réunions et niveaux de détail

| Type de réunion | Niveau de détail recommandé |
|-----------------|------------------------------|
| Réunion d'équipe / point hebdo | Synthétique: décisions et actions |
| Point projet | Standard: + résumé par sujet |
| Comité de direction | Standard à détaillé: décisions tracées avec contexte |
| Assemblée / réunion statutaire | Procès-verbal formel: nominatif, votes, résolutions |
| Réunion client | Standard: + relevé de décisions à partager |
...
|--------|---------------------------|-------------|
| Transformer un débat en décision | Fausse la mémoire collective | Une décision = un choix arrêté, sinon `[A VALIDER]` |
| Action sans responsable | Personne ne la fait | Nommer un responsable ou `[A COMPLETER]` |
| Action sans échéance | Jamais suivie | Dater ou `[A COMPLETER]` |
| Inventer un détail manquant | Compte-rendu non fiable | Laisser `[A COMPLETER]`, demander |
| Compte-rendu interprétatif | Perte de neutralité | Rapporter les faits, pas les intentions |
| Transcription mot à mot | Illisible, inutilisable | Synthétiser sans déformer |
| Tout mélanger en un bloc | Décisions et actions noyées | Structurer par sujet, puis tableau d'actions |
